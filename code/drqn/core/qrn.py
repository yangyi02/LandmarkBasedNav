...
from utils.replay_buffer_dqrn import ReplayBuffer

class QRN(object):
    """
    Abstract Class for implementing a Q Network
    Mainly for training and test schedule
    """
    ...
    def get_best_action(self, state, h_state):
        ...
        Returns:
            tuple: action, q values, h_state
        """
        raise NotImplementedError


    def get_action(self, state, h_state):
        """
        ...
        Args:
            ...
            h_state: hidden state for rnn
        """
        best_action, q_values, h_state_out = self.get_best_action(state, h_state)
    ...
    def train(self, exp_schedule, lr_schedule):
        ...
        while t < self.config.nsteps_train:
            ...
            for i in range(500):
                ...
                best_action, q_values, h_state = self.get_best_action(q_input, h_state)
    ...
    def evaluate(self, env=None, num_episodes=None):
        ...
        for i in range(num_episodes):
            ...
            for j in range(1000):
                ...
                action, _, h_state = self.get_action(q_input, h_state)
