...
class ReplayBuffer(object):
    ...
    def _encode_sample(self, idxes):
        ...
        for idx in idxes:
            obs, act, rew, dmsk, smsk, seqlen = self._encode_observation2(idx)
            ...
            next_obs, _, _, _, _, next_seqlen = self._encode_observation2(idx+1)
        ...
        return obs_batch, seqlen_batch, act_batch, past_act_batch, rew_batch, done_mask, seq_mask, next_obs_batch, next_seqlen_batch
