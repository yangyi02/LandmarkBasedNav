class config():
    ...
    # output config
    output_path  = "results/two_agent_2/"
    ...
    num_episodes_test = 300 # 100 how many episodes to use while computing test rewards
    grad_clip         = True
    clip_val          = 10 # 10
    saving_freq       = 20000 # steps 250000
    log_freq          = 100 # steps, should be multiple of learning_freq
    eval_freq         = 5000 # steps between two evaluation 250000
    soft_epsilon      = 0.0
    ...
    # restore config
    restore_param = True
    restore_t = 500000 # 8x8
    deploy_only = True
    vis_heat_map = True

    visible_radius_unit_side = 2
    visible_radius_unit_front = 4 # 4
    map_config_file = './maps/four_room_random_apple5.json'
    ego_centric = True
